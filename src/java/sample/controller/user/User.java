...
public class User extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("checkLogin")) {
            ...
            dtos.UserDTO user = dao.checkUser(user_email, user_pass);
            if (user == null) {
        ...
        if (action.equals("myaccount")) {
            try {
                ...
                if (user != null) {
                    ...
                    List<BillDTO> bill = dao.getBillByID(user_id);
        ...
        if (action.equals("showdetail")) {
            ...
            billDAO dao = new billDAO();
            List<BillDetailDTO> detail = dao.getDetail(id);
        ...
        if (action.equals("updateinfo")) {
            try {
                ...
                if (user != null) {
                    ...
                    dtos.UserDTO user1 = new dtos.UserDTO(user.getUser_id(), user_name, user.getUser_email(), user_pass, user.getIsAdmin());
        ...
        if (action.equals("signup")) {
            ...
            if (!user_pass.equals(re_pass)) {
                ...
                userDAO dao = new userDAO();
                dtos.UserDTO a = dao.checkAcc(user_email);
                if (a == null) {
