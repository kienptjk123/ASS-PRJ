<%-- 
    Document   : register
    Created on : Jun 23, 2024, 11:29:46 AM
    Author     : adm
--%>
    ...
    <body>
                ...
                <div class="breadcrumbs_area other_bread">
                    <div class="body-content" style="display: flex; margin-left: 20px; gap: 140px">   
                        ...
                        <div class="login-header" style="display: flex; margin: auto 0; gap: 10px">
                            <a style="color: black; font-size: 1.2rem; margin: auto 0" href="./login.jsp">
                                Đăng nhập
                            </a>
                            <p style="margin: auto 0">|</p>
                            <a style=" font-size: 1.2rem; margin: auto 0" href="./register.jsp">
                                Đăng ký
                            </a>
                        </div>
                    </div>         
        ...
        <style>
            * {
            ...
            .form-login .account_form form input[type="email"]{
                width: 120%;
                padding: 10px;
                border: 0;
